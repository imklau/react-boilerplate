...
const scripts = `"start": "webpack serve -c ./webpack.dev.js",
...
exec(
  ...
  (initErr, initStdout, initStderr) => {
    ...
    const filesToCopy = ["webpack.dev.js", "webpack.prod.js"]
    ...
    exec(
      `cd ${process.argv[2]} && git init && node -v && yarn -v && yarn add -D ${devDeps} && yarn add -S ${deps}`,
